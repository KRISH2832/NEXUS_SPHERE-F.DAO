...
const UpdateProject = ({ project }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-purple-900 shadow-xl shadow-black
        rounded-xl w-11/12 md:w-2/5 h-7/12 p-6"
      >
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="flex justify-between items-center">
            <p className="font-semibold text-white">Edit Project</p>
            <button
              onClick={onClose}
              type="button"
          ...
          >
            ...
            border-0 text-sm text-white focus:outline-none
            focus:ring-0"
              type="text"
              name="title"
              placeholder="Title"
          ...
          <button
            ...
            rounded-full shadow-md hover:bg-purple-600 mt-5"
          >
            Update Project
          </button>
        </form>
