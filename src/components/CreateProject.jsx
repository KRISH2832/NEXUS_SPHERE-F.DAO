...
const CreateProject = () => {
  ...
  return (
    ...
    items-center justify-center bg-rgb(28, 27, 34) bg-opacity-50
      ...
      >
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="flex justify-between items-center">
            <p className="font-semibold">Create Club</p>
            <button
              onClick={onClose}
              type="button"
          ...
          <button
            ...
            rounded-full shadow-md hover:from-violet-500 hover:to-violet-900 mt-5"
          >
            Submit Club Requirements
          </button>
        </form>
      </div>
    </div>
